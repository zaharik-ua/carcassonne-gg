...
Список турнірів і верхня картка вибраного турніру показують його `logo_url`, якщо
він заданий; технічний tournament ID не дублюється як badge. Після завершення
турніру під назвою, поза вкладками, відображаються підсумкові місця 1–4.
