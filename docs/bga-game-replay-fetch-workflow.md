...
Replay gateway використовує перший рівень, у якому є хоча б один акаунт без
активного cooldown. Тому:

- акаунт 4 доступний лише тоді, коли всі налаштовані акаунти 1–3 одночасно
  мають активний cooldown;
- акаунт 5 доступний лише тоді, коли всі налаштовані акаунти 1–4 одночасно
  мають активний cooldown;
- вичерпання локального rolling-бюджету попереднього рівня не розблоковує
  наступний рівень;
